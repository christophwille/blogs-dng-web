    ...
    public partial class Default : System.Web.UI.Page {
        ...
        void ListView1_ItemDataBound(object sender, ListViewItemEventArgs e)
        {
            if (e.Item.ItemType == ListViewItemType.DataItem) {
                ...
                TitleLabel.Text = Server.HtmlEncode(string.Format("{0}: {1}", item.Authors[0].Name, item.Title.Text));
                ...
                //if(ItemHyperLink.NavigateUrl != string.Empty && ItemHyperLink.NavigateUrl != "#") {
                //    Uri uri = new Uri(item.Id);
                ...
                //    }
                //    ItemHyperLink.NavigateUrl +=
                //        "utm_source=dotnetgermanbloggers&utm_medium=site&utm_campaign=blogs.dotnetgerman.com";
                //}
            }
        }
    }
