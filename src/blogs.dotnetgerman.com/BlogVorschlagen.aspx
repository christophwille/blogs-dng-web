...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	<h2 title="Blog anmelden">
		Blog anmelden</h2>
	<p>
		Die bei DotNetGerman Bloggers gelisteten Artikel werden via RSS- oder Atom-Feed 
		bei DotNetGerman Bloggers eingelesen.<br />
		<br />
		Sollen auch Deine Artikel hier gelistet werden, benötigen wir von Dir einen 
		validen RSS- oder Atom-Feed.<br />
		<br />
		Erstelle hierfür bitte eine Blog-Kategorie &quot;DotNetGerman Bloggers&quot;, in der alle 
		Blog-Postings liegen müssen, die bei DotNetGerman Bloggers gelistet werden 
		sollen. Diese Kategorie muß als RSS-Feed abrufbar sein. Alternativ wenn Du 
		bereits eine reine .NET Kategorie besitzt, kannst Du diese auch gleich anmelden.
		<br />
		<br />
		Aufnahmekritierien:</p>
	<ul>
		<li>Sprache: deutsch / englisch</li>
		<li>Themen: <a href="http://de.wikipedia.org/wiki/Microsoft_.NET">Microsoft .NET</a> und verwandte Technologien<span style="color:Red"> (keine Familienstories, kein 
	...
	<asp:UpdatePanel ID="AddBlogUpdatePanel" runat="server">
		<ContentTemplate>
			<div style="border: 1px dashed #99CC33; padding: 10px; width: 350px;">
					...
					<asp:RequiredFieldValidator ID="nameRequired" runat="server" ControlToValidate="nameTextBox"
						...
						ToolTip="Vorname und Nachname fehlen." EnableClientScript="False" CssClass="validationerror" ForeColor="">*</asp:RequiredFieldValidator>
				</p>
					...
					<asp:RequiredFieldValidator ID="blogUrlRequired" runat="server" ControlToValidate="blogUrlTextBox"
						...
						ToolTip="Blog-Url fehlt." EnableClientScript="False" CssClass="validationerror" ForeColor="">*</asp:RequiredFieldValidator>
				</p>
				...
				<p>
					...
					<asp:RequiredFieldValidator ID="blogUrlRequired0" runat="server" ControlToValidate="blogFeedUrlTextBox"
						...
						ToolTip="Blog-Feed-Url fehlt." EnableClientScript="False" CssClass="validationerror" ForeColor="">*</asp:RequiredFieldValidator>
				</p>
					...
					<asp:RequiredFieldValidator ID="emailRequired" runat="server" ControlToValidate="emailTextBox"
						...
						ToolTip="E-Mail fehlt." EnableClientScript="False" CssClass="validationerror" ForeColor="">*</asp:RequiredFieldValidator>
					<asp:RegularExpressionValidator ID="emailValid" runat="server" ControlToValidate="emailTextBox"
						...
						ValidationGroup="AddBlog" EnableClientScript="False" CssClass="validationerror" ForeColor="">*</asp:RegularExpressionValidator>
				</p>
				<h6>Spam-Schutz</h6>
				<p>Bitte die Zahl aus dem Bild in das Feld darunter eintippen:<br />
					...
					<asp:RequiredFieldValidator ID="CaptchaRequired" runat="server" 
						...
						ValidationGroup="AddBlog" EnableClientScript="False" CssClass="validationerror" ForeColor="">*</asp:RequiredFieldValidator>
					...
					<asp:CustomValidator ID="CaptchaValidation" runat="server" Display="Dynamic" 
						...
						ToolTip="Falsche Prüfsumme." ValidationGroup="AddBlog" CssClass="validationerror" ForeColor="">*</asp:CustomValidator>
					
				</p>
				<asp:ValidationSummary ID="ValidationSummary1" runat="server" DisplayMode="List"
					HeaderText="Bei der Anmeldung sind Fehler auftreten:" ValidationGroup="AddBlog" 
					EnableClientScript="False" CssClass="validationerror" ForeColor="" />
				<p>
				<div style="color:Red; font-weight:bold">
				Nochmal der Hinweis (da es weiter oben offenbar nicht gelesen wird): Es werden nur Blogs aufgenommen, die sich mit <a href="http://de.wikipedia.org/wiki/.NET">Microsoft .NET</a> (bitte klickt auf den Link, wenn Ihr nicht wisst, was .NET ist - es ist nicht das Internet!) und damit eng verwandten Themen befassen.<br />Blogs über Hunde, Katzen, Fußball, Versicherungen oder sonstiges werden nicht aufgenommen. Es wird keine Antwort verschickt - die Anfragen werden direkt gelöscht. Bitte spart uns und Euch diese unnötige Arbeit. Danke.
				</div>
